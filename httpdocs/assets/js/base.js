...
app.controller('projectsController', function($scope){
	...
	$scope.projects = [
		{'id': 1, 'name': 'Kindrd', 'url': 'http://kindrd.com/', 'img': 'assets/img/work/kndrd.jpg'},
		{'id': 2, 'name': 'Swatch #thisislove (Ran Feb 2015)', 'url': 'http://thisislove.swatch.com/', 'img': 'assets/img/work/swatch.jpg'},
		{'id': 3, 'name': 'Fascinating People', 'url': 'http://www.fascinating-people.de/', 'img': 'assets/img/work/pro7.jpg'},
		{'id': 4, 'name': 'Lern Helfer', 'url': 'http://www.lernhelfer.de/', 'img': 'assets/img/work/lernhelfer.jpg'},
		{'id': 5, 'name': 'FCBinferno', 'url': 'http://www.fcbinferno.com/', 'img': 'assets/img/work/draft.jpg'},
		{'id': 6, 'name': 'Lovespace', 'url': 'http://Lovespace.co.uk/', 'img': 'assets/img/work/lovespace.jpg'},
		{'id': 7, 'name': 'The Guardian #localshopping', 'url': 'http://www.theguardian.com/lifeandstyle/interactive/2012/dec/08/local-shopping-map-photos-twitter-instagram', 'img': 'assets/img/work/localshopping.jpg'},
		{'id': 8, 'name': 'The Guardian #gdngig', 'url': 'http://www.theguardian.com/music/interactive/2012/nov/23/live-music-map-gig-photos-twitter', 'img': 'assets/img/work/gdngig.jpg'},
		...
		{'id': 9, 'name': 'The Creative Directory', 'url': 'http://thecreativedirectory.com/', 'img': 'assets/img/work/tcd.jpg'},
		//{'id': 8, 'name': 'Jaguar Desire Poster Competion', 'url': 'http://postercompetition.f-type.com/en_GB/', 'img': 'assets/img/work/jaguar.jpg'},
		{'id': 10, 'name': 'Action for Happines', 'url': 'http://actionforhappiness.org/', 'img': 'assets/img/work/action-for-happiness.jpg'}
